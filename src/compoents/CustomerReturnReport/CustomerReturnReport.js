...
import "./CustomerReturnReport.scss";
import OtherKeyData from "./CustomerReturnReport.json";
...
export default function CustomerReturnReport() {
  ...
  const fetchData = async (stat, end) => {
    ...
    setIsLoading(true);
    const body = {
      con: `{"id":"","mode":"customerreturn","appuserid":"${AllData?.uid}"}`,
  ...
  return (
    <DragDropContext onDragEnd={onDragEnd}>
      <div
        className="CustomerReturnReportMain_mainGridView"
