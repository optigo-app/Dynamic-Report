...
import "./StockDetailOUTTemp.scss";
...
import OtherKeyData from "./StockDetailOUTTemp.json";
...
export default function StockDetailOUTTemp() {
  ...
  }, [allColumData, masterData, grupEnChekBox, sortModel, paginationModel]);
