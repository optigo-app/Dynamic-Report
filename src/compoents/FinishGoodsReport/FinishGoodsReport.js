...
import OtherKeyData from "./FinishGoodsReport.json";
...
export default function FinishGoodsReport() {
  ...
  const fetchData = async (stat, end) => {
    ...
    setIsLoading(true);
    const body = {
      con: `{"id":"","mode":"finishgoodsreport","appuserid":"${AllData?.uid}"}`,
  ...
  return (
    <DragDropContext onDragEnd={onDragEnd}>
      <div
        className="FinishGoodsReport_report_main"
