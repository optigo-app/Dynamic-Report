...
import OtherKeyData from "./MFGReturnJob.json";
...
export default function MFGReturnJob() {
  ...
  const fetchData = async (stat, end) => {
    ...
    setIsLoading(true);
    const body = {
      con: `{"id":"","mode":"mfgreturnjob","appuserid":"${AllData?.uid}"}`,
  ...
  return (
    <DragDropContext onDragEnd={onDragEnd}>
      <div
        className="mainGridView mfgReturnJob_main"
