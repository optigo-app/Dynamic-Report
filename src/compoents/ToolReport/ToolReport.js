// http://localhost:3000/testreport/?sv=/e3tsaXZlLm9wdGlnb2FwcHMuY29tfX17ezIwfX17e3Rlc3Q3M319e3t0ZXN0NzN9fQ==/1&ifid=ToolsReport&pid=1580

import React, { useState, useEffect, useRef } from "react";
import Box from "@mui/material/Box";
import { DataGrid } from "@mui/x-data-grid";
import "./ToolReport.scss";
...
import OtherKeyData from "./ToolReport.json";
...
export default function ToolReport() {
  ...
  const fetchData = async (stat, end) => {
    ...
    setIsLoading(true);
    const body = {
      con: `{"id":"","mode":"tools","appuserid":"${AllData?.uid}"}`,
  ...
  useEffect(() => {
    ...
    const updatedRows = groupRows(originalRows, grupEnChekBox); // not filteredRows
  ...
  return (
    <DragDropContext onDragEnd={onDragEnd}>
      <div
        className="ToolReportMain_mainGridView"
